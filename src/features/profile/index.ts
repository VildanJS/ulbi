...
export type { ProfileSchema } from './getProfileCardData/model'

export { fetchProfileData, updateProfileData } from './getProfileCardData/model'

export { setReadonly, setProfileData } from './getProfileCardData/model'
