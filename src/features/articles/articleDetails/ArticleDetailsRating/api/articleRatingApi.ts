...
export const useRateArticleRatingMutation = articleRatingApi.useRateArticleRatingMutation
export const useUpdateArticleRatingMutation = articleRatingApi.useUpdateArticleRatingMutation
